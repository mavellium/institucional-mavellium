...
export default function AboutUsSection() {
  ...
  return (
    <section
      id="about-section"
      ref={sectionRef}
      className="w-full py-24 px-4 bg-gradient-to-b from-[#363535] to-[#000000] text-[#202e44] overflow-hidden relative"
    >
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/4 w-4 h-4 rounded-full bg-[#95beed]/30"
        animate={{
          y: [0, -15, 0],
          opacity: [0.5, 1, 0.5],
        }}
      ...
      >
        <motion.div className="flex flex-col items-center mb-6" variants={itemVariants}>
          <motion.span
            className="text-[#95beed] font-medium mb-2 flex items-center gap-2"
          ...
          <h2 className="text-4xl md:text-5xl font-light mb-4 text-white text-center">About Us</h2>
          <motion.div
            className="w-24 h-1 bg-[#95beed]"
            initial={{ width: 0 }}
            animate={{ width: 96 }}
          ...
          <div className="flex justify-center items-center order-first md:order-none mb-8 md:mb-0">
            <motion.div className="relative w-full max-w-xs" variants={itemVariants}>
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-t from-white/50 to-transparent flex items-end justify-center p-4"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
              ...
              <motion.div
                className="absolute inset-0 border-4 border-[#95beed] rounded-md -m-3 z-[-1]"
              ...
              <motion.div
                className="absolute -top-4 -right-8 w-16 h-16 rounded-full bg-[#95beed]/10"
              ...
              ></motion.div>
              <motion.div
                className="absolute -bottom-6 -left-10 w-20 h-20 rounded-full bg-[#95beed]/15"
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                className="absolute -top-10 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-[#95beed]"
                animate={{
                  y: [0, -10, 0],
                  opacity: [0.5, 1, 0.5],
                }}
...
interface ServiceItemProps {
  ...
  variants: {
    ...
    visible: { y: number; opacity: number; transition: { duration: number; ease: "easeOut" } }
  }
  delay: number
...
function ServiceItem({ icon, secondaryIcon, title, description, variants, delay, direction }: ServiceItemProps) {
  return (
    ...
    >
      ...
      >
        <motion.div
          className="text-white bg-black/40 p-3 rounded-lg transition-colors duration-300 group-hover:bg-[#95beed]/20 relative"
          whileHover={{ rotate: [0, -10, 10, -5, 0], transition: { duration: 0.5 } }}
        >
          {icon}
          {secondaryIcon}
        </motion.div>
        <h3 className="text-xl font-medium text-white group-hover:text-[#95beed] transition-colors duration-300">
          {title}
        </h3>
      </motion.div>
      <motion.p
...
function StatCounter({ icon, value, label, suffix, delay }: StatCounterProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="w-14 h-14 rounded-full bg-[#202e44]/20 flex items-center justify-center mb-4 text-white/50 group-hover:text-[#95beed] group-hover:bg-[#88734C]/10 transition-colors duration-300"
      ...
      <motion.div className="w-10 h-0.5 bg-black/50 group-hover:bg-[#95beed] mt-3 group-hover:w-16 transition-all duration-300" />
    </motion.div>
  )
}