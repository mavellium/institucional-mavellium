                            ...
                            <div className="mx-auto max-w-lg text-center text-white lg:ml-0 lg:max-w-full lg:text-left">
                                ...
                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    <Button
                                        asChild
                                        size="lg"
                                        className="h-12 rounded-full pl-5 bg-white text-black hover:bg-white/50 pr-3 text-base">
                                        <Link href="#link">
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="h-12 rounded-full px-5 text-base hover:text-white hover:bg-white/40">
                                        <Link href="#link">
                        ...
                        <div className="aspect-[2/3] absolute inset-1 overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5">
                            <div className="relative w-full h-full">
                                <iframe
                                    ...
                                    allowFullScreen
                                />
                                <div className="absolute inset-0 w-full h-full bg-transparent cursor-default" />
                            </div>
                        </div>
                    </div>
                </section>
