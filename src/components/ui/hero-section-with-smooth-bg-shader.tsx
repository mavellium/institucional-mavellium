...
export function HeroSection({
  ...
  onButtonClick,
  colors = ["#000000", "#1F1F1F", "#000000", "#676767", "#b7b6b6", "#bdbdbd"],
  distortion = 0.8,
  swirl = 0.6,
  speed = 0.42,
  offsetX = 0.08,
      ...
      <div className={`relative z-10 ${maxWidth} mx-auto px-6 w-full`}>
        <div className="text-center">
          ...
          <button
            ...
            className={`px-6 py-4 sm:px-8 sm:py-6 rounded-full border-2 bg-[rgb(81, 85, 93)] border-card text-sm sm:text-base text-white hover:bg-[rgba(97, 95, 95, 0)] transition-colors ${buttonClassName}`}
          >
            {buttonText}
          </button>
        </div>
